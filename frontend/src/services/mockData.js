...
const buildListeningExercise = (audience = 'adult') => {
  ...
  return {
    ...
    questions: [
      createQuestion({
        question: '¿Qué se dijo en el audio?',
        options: ['Saludo', 'Despedida', 'Pregunta'],
        correctAnswer: 'Saludo',
        correct: '¡Buena escucha!',
        incorrect: 'Escucha una vez más e intenta de nuevo.',
      }),
      createQuestion({
        question: '¿Cuál es el tono principal de la conversación?',
        options: ['Formal', 'Casual', 'Urgente'],
        correctAnswer: 'Casual',
        correct: '¡Excelente percepción!',
        incorrect: 'Escucha nuevamente prestando atención al tono.',
      }),
      createQuestion({
        question: '¿Cuántas personas están hablando?',
        options: ['Una', 'Dos', 'Tres'],
        correctAnswer: 'Dos',
        correct: '¡Perfecto!',
        incorrect: 'Intenta contar las voces nuevamente.',
      }),
      createQuestion({
        question: '¿Qué está haciendo el hablante principal?',
        options: ['Saludando', 'Despidiéndose', 'Preguntando'],
        correctAnswer: 'Despidiéndose',
        correct: '¡Excelente comprensión!',
        incorrect: 'Concéntrate en el final del diálogo.',
      }),
      createQuestion({
        question: '¿Qué expresión se usó en el audio?',
        options: ['¡Hola!', '¡Adiós!', '¿Cómo estás?'],
        correctAnswer: '¡Adiós!',
        correct: '¡Eres un excelente oyente!',
        incorrect: 'Escucha la despedida con más atención.',
      }),
      createQuestion({
        question: '¿Cuál es el contexto de esta conversación?',
        options: ['Reunión de trabajo', 'Encuentro casual', 'Entrevista'],
        correctAnswer: 'Encuentro casual',
        correct: '¡Muy bien!',
        incorrect: 'Piensa dónde ocurre la conversación.',
      }),
    ],
  };
};
